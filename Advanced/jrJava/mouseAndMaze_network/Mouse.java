...
public class Mouse implements KeyListener, Runnable {
	...
	private Point[] eyeTemplate = { new Point(60, -16), new Point(60, 16) };
	private Point eyeRadius = new Point(12, 12);
	...
	public void receiveData(String msg){
		...
		int newCompass = Integer.parseInt(st.nextToken());
		setDirection(newCompass);
	}
	...
	public void keyPressed(KeyEvent e){
		...
		if(keyCode==e.VK_LEFT) newCompass = 0;
		else if(keyCode==e.VK_UP) newCompass = 1;
		else if(keyCode==e.VK_RIGHT) newCompass = 2; 
		else if(keyCode==e.VK_DOWN) newCompass = 3;
		
		setDirection(newCompass);
	}
	
	
	public void setDirection(int newCompass){ 
		
		if(newCompass==0){ xSpeed = -1; ySpeed = 0; }
		else if(newCompass==1){ xSpeed = 0; ySpeed = -1; }
		else if(newCompass==2){ xSpeed = 1; ySpeed = 0; }
		else if(newCompass==3){ xSpeed = 0; ySpeed = 1; }
